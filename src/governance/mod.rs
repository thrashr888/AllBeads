...
pub use scanner::{
    ...
    print_scan_result, DetailedInfo, FieldSet, GitHubScanner, OnboardingPriority, ScanField,
    ScanFilter, ScanOptions, ScanResult, ScanSource, ScanSummary, ScannedRepo,
};
